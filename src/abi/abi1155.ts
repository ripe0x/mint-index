export const abi1155 = [
  ...
  { inputs: [], name: "MintPriceNotMet", type: "error" },
  { inputs: [], name: "NonExistentRenderer", type: "error" },
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "tokenDescription", type: "string" },
      { internalType: "bytes[]", name: "tokenArtifact", type: "bytes[]" },
      { internalType: "uint32", name: "tokenRenderer", type: "uint32" },
      { internalType: "uint128", name: "tokenData", type: "uint128" },
    ],
    name: "create",
    outputs: [],
    stateMutability: "nonpayable",
  ...
  },
  {
    inputs: [
      ...
      { internalType: "string", name: "contractDescription", type: "string" },
      { internalType: "bytes[]", name: "contractImage", type: "bytes[]" },
